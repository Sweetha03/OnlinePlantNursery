...
class SeedServiceImplTest {
	...
	void testAddSeed() {
		...
		Seed sampleInput= new Seed("Rose", "11.11", "5 ounces", "Moderate", 7, 32, "Flower", "It is an mature ovule that compromises a miniature undeveloped plant", 7, 7.17, 7);
		//actual output
		Seed actualOutput = new Seed("Rose", "11.11", "5 ounces", "Moderate", 7, 32, "Flower", "It is an mature ovule that compromises a miniature undeveloped plant", 7, 7.17, 7);
		
		actualOutput.setCommonName(null);
		actualOutput.setTypeOfSeeds(null);
		
		Seed expectedOutput = new Seed("Rose", "11.11", "5 ounces", "Moderate", 7, 32, "Flower", "It is an mature ovule that compromises a miniature undeveloped plant", 7, 7.17, 7);
		
		expectedOutput.setCommonName(null);
		expectedOutput.setTypeOfSeeds(null);
